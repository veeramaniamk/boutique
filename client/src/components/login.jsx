...
const Login = () => {
  return (
    <section className="py-3 py-md-5 login-backimg">
                  ...
                  <div className="row gy-2 overflow-hidden">
                    ...
                    <div className="col-12">
                      <div className="d-grid my-1">
                        <button className="sign-color" type="submit">Sign up</button>
                      </div>
                    </div>
                    <div className="col-12">
                      <p className="m-0 text-secondary text-center">
                        ...
                        {/* <a  href="/register" className="link-primary text-decoration-none">Sign up</a> */}
                      </p>
                    </div>
                  </div>
                </form>
